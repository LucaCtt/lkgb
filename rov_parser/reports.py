...
class ParserReport:
    ...
    def find_very_similar_logs_done(self) -> None:
        """
        Updates the timestamp indicating when very similar logs were last processed.

        This method sets the `very_similar_logs_dt` attribute to the current date and time
        in UTC timezone, marking the completion time of processing very similar logs.
    ...
    def find_similar_logs_done(self) -> None:
        """
        Updates the timestamp for when similar logs were last found.

        This method sets the `similar_logs_dt` attribute to the current date and time in UTC.
    ...
    def template_generation_done(self) -> None:
        """
        Marks the template generation as completed by setting the current
        datetime with UTC timezone to the attribute `template_generation_dt`.
    ...
    def finish(self) -> "ParserReport":
        ...
        This method sets the `end_dt` attribute to the current datetime with UTC timezone,
        indicating the completion of the parsing process.
